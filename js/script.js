...
function fetchVideos(endpoint, params = {}) {
  ...
  const url = `https://invidious.jing.rocks/api/v1/${endpoint}?${new URLSearchParams(params)}`;
...
function fetchMultipleEndpoints() {
  ...
  const endpoints = [
    { url: 'https://invidious.jing.rocks/api/v1/trending?type=music', type: 'music' },
    { url: 'https://invidious.jing.rocks/api/v1/trending?type=gaming', type: 'gaming' },
    { url: 'https://invidious.jing.rocks/api/v1/trending?type=news', type: 'news' },
    { url: 'https://invidious.jing.rocks/api/v1/trending?type=movies', type: 'movies' },
    { url: 'https://invidious.jing.rocks/api/v1/trending?type=all', type: 'all' }
  ];
